...
``Definings Pathways for Solving Envrionmental Challenges using Machine Learning'' \emph{AEESP Annual Conference}, 2023, Organizer

``A Convergence of WRF Machine Learning Based Controller
Implementation and Research'' \emph{WEF/IWA Innocations in Process Engineering}, June 6, 2023, Facilitator and presenter
...
``Understanding and Embracing Machine Learning, Artificial Intelligence and Predictive Analytics'' Metropolitan Water Reclamation District of Greater Chicago Seminar Series, June 30, 2023
